    ...
    <div>
      <div className="w-full relative">
        <div className="text-center absolute top-[30%] px-10 z-[100] md:text-white ">
          ...
          <p className="mt-4 text-lg font-dank">
            At Edutopia, we make finding your perfect home an effortless
            experience. Our curated selection of properties caters to every
            lifestyle, from chic urban apartments to cozy suburban houses and
            luxurious beachfront villas. Explore our listings today and find a
            place that feels just right for you.
          </p>
          <div className="mt-10">
            <button
              style={{
        ...
        <div className="md:h-[50rem] h-[45rem] w-full md:brightness-[30%]">
          <img
            src="https://img.freepik.com/free-photo/mumbai-skyline-skyscrapers-construction_469504-21.jpg?size=626&ext=jpg&ga=GA1.1.337082422.1717413067&semt=ais_user"
            alt=""
      ...
      {/* About Etopia */}
      <div className="  flex  justify-around w-full  items-center  md:flex-row flex-col p-2 md:relative text-center md:mt-[8rem] ">
        <div className="md:w-[55%]  w-full flex  flex-col justify-around gap-6 r">
          <button class="smky-btn3 cursor-default relative hover:text-[#778464] py-2 px-6 after:absolute after:h-1 after:hover:h-[200%] transition-all duration-500 hover:transition-all hover:duration-500 after:transition-all after:duration-500 after:hover:transition-all after:hover:duration-500 overflow-hidden z-20 after:z-[-20] after:bg-[#abd373] after:rounded-t-full after:w-full after:bottom-0 after:left-0 text-gray-600">
            <Link to={"/about"} className="font-dank">
              About Us
            </Link>
          </button>
          <p className="md:mt-2  w-full border font-medium font-serif">
            ...
            order for them to reach their goals we provide all necessary
            assistance. Our basic duty at concrete ...
          </p>
